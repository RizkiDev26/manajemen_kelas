...
<div class="mb-8">
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 mb-3 pl-2">Tambah Data Siswa</h1>
            <p class="text-gray-600 pl-2">Tambahkan data siswa baru ke dalam sistem</p>
        </div>
...
<div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 overflow-hidden pl-2">
    <div class="px-6 py-4 border-b border-gray-200">
        <h3 class="text-lg font-semibold text-gray-900">Form Tambah Siswa</h3>
        <p class="text-sm text-gray-500 mt-1">Lengkapi semua field yang wajib diisi (*)</p>
    </div>

    <form action="/admin/data-siswa/store" method="POST" class="p-6">
        <?= csrf_field() ?>
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="nipd" name="nipd" value="<?= old('nipd') ?>"
                           class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white/80 backdrop-blur-sm transition-all duration-300"
        ...
        <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
            ...
            <button type="submit" 
                    class="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-8 py-3 rounded-xl font-medium transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105">
                Simpan Data Siswa
            </button>
        </div>
    </form>
