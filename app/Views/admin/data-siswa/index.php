    ...
    <div class="mb-8">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex space-x-3">
                ...
                <button id="exportExcel" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200 flex items-center space-x-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                    <span>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (exportExcelBtn) {
        exportExcelBtn.addEventListener('click', function(e) {
            ...
            if (jkValue) params.append('jk', jkValue);
            
            // Create download URL
            const downloadUrl = `/admin/data-siswa/export-excel?${params.toString()}`;
