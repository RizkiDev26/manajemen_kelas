        ...
        <nav class="flex-1 p-6 overflow-y-auto">
            <div class="mb-8">
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="/admin/daftar-hadir" class="flex items-center space-x-3 py-3 px-4 rounded-lg transition-all duration-200 <?= uri_string() === 'admin/daftar-hadir' ? 'bg-white/10 text-white border-l-4 border-white' : 'text-white/80 hover:bg-white/5 hover:text-white' ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                            </svg>
                            <span class="font-medium">Daftar Hadir</span>
                        </a>
                    </li>
                    <li>
